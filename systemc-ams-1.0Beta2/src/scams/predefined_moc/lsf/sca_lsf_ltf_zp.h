...
/*****************************************************************************
 ...
 SVN Id            :  $Id: sca_lsf_ltf_zp.h 1102 2011-01-02 22:18:22Z karsten $
...
public:
	...
	explicit sca_ltf_zp(sc_core::sc_module_name, const sca_util::sca_vector<
			sca_util::sca_complex>& zeros_ = sca_util::sca_vector<
			sca_util::sca_complex>(), const sca_util::sca_vector<
			sca_util::sca_complex>& poles_ = sca_util::sca_vector<
			sca_util::sca_complex>(), double k_ = 1.0);
