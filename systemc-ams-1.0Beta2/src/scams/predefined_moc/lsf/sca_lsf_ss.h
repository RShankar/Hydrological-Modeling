...
/*****************************************************************************
 ...
 SVN Id            :  $Id: sca_lsf_ss.h 1102 2011-01-02 22:18:22Z karsten $
...
public:
	...
	explicit sca_ss(sc_core::sc_module_name,
			const sca_util::sca_matrix<double>& a_ = sca_util::sca_matrix<
					double>(), const sca_util::sca_matrix<double>& b_ =
					sca_util::sca_matrix<double>(), const sca_util::sca_matrix<
					double>& c_ = sca_util::sca_matrix<double>(),
			const sca_util::sca_matrix<double>& d_ = sca_util::sca_matrix<
					double>(), sca_core::sca_time delay_=sc_core::SC_ZERO_TIME);
