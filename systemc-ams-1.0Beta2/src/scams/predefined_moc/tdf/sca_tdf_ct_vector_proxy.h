...
/*****************************************************************************
 ...
 SVN Id            :  $Id: sca_tdf_ct_vector_proxy.h 969 2010-03-01 21:34:37Z karsten $
...
public:
	...
	void
			to_matrix(sca_util::sca_matrix<double>&, unsigned long nsamples = 0) const;
	...
	void
			to_port(sca_tdf::sca_de::sca_out<sca_util::sca_vector<double> >&) const;
...
private:
	...
	virtual void  convert_to_sca_port(sca_tdf::sca_out<sca_util::sca_vector<double> >&)=0;
...
inline void sca_ct_vector_proxy::assign_to(sca_tdf::sca_out<sca_util::sca_vector<double> >& port)
{
...
inline void sca_ct_vector_proxy::to_port(sca_tdf::sca_out<sca_util::sca_vector<double> >& port) const
{
