...
/*****************************************************************************
 ...
 SVN Id            :  $Id: sca_tdf_ct_proxy.h 969 2010-03-01 21:34:37Z karsten $
...
public:
	...
	void
			to_vector(sca_util::sca_vector<double>&, unsigned long nsamples = 0) const;
...
private:
	...
	virtual void convert_to_sca_port(sca_tdf::sca_out<double>&)=0;
...
inline void sca_ct_proxy::assign_to(sca_tdf::sca_out<double>& port)
{
...
inline void sca_ct_proxy::to_port(sca_tdf::sca_out<double>& port) const
{
