...
/*****************************************************************************
 ...
 SVN Id            :  $Id: sca_ac_functions.h 1035 2010-07-22 11:33:16Z karsten $
...
sca_util::sca_complex sca_ac_ltf_nd(const sca_util::sca_vector<double>& num,
		...
		const sca_util::sca_complex& input = 1.0, double k = 1.0);

sca_util::sca_complex sca_ac_ltf_nd(const sca_util::sca_vector<double>& num,
		const sca_util::sca_vector<double>& den, sca_core::sca_time delay,
		const sca_util::sca_complex& input = 1.0, double k = 1.0);
...
sca_util::sca_complex sca_ac_ltf_zp(const sca_util::sca_vector<
		sca_util::sca_complex>& zeros, const sca_util::sca_vector<
		sca_util::sca_complex>& poles, sca_core::sca_time delay,
		const sca_util::sca_complex& input = 1.0, double k = 1.0);
...
sca_util::sca_vector<sca_util::sca_complex> sca_ac_ss(
		const sca_util::sca_matrix<double>& a, const sca_util::sca_matrix<
				double>& b, const sca_util::sca_matrix<double>& c,
		const sca_util::sca_matrix<double>& d, sca_core::sca_time delay,
		const sca_util::sca_vector<
				sca_util::sca_complex>& input);
...
//LRM clause 5.2.2.1.
template<class T>
sca_util::sca_complex& sca_ac(const sca_tdf::sca_out<T>& port)
{
...
//LRM clause 5.2.2.2.
template<class T>
sca_util::sca_complex& sca_ac_noise(const sca_tdf::sca_out<T>& port)
{
	return sca_implementation::sca_ac_noise(port);
}

template<class T>
const sca_util::sca_complex& sca_ac(const sca_tdf::sca_in<T>& port)
{
	return sca_implementation::sca_ac(port);
}
...
template<class T>
const sca_util::sca_complex& sca_ac_noise(const sca_tdf::sca_in<T>& port)
{
	return sca_implementation::sca_ac_noise(port);
}
