...
/*****************************************************************************
  ...
  Created on: 07.01.2010
   ...
   SVN Id            :  $Id: sca_lsf_tdf_mux.cpp 1113 2011-01-23 16:09:13Z karsten $
...
void sca_mux::matrix_stamps()
{
    ...
    add_pre_solve_method(SCA_VMPTR(sca_mux::update_ctrl));
    add_post_solve_method(SCA_VMPTR(sca_mux::read_ctrl));
}
