...
/*****************************************************************************
 ...
 SVN Id            :  $Id: sca_tdf_ltf_nd.cpp 969 2010-03-01 21:34:37Z karsten $
...
void sca_ltf_nd::set_max_delay(sca_core::sca_time ct_delay)
{
...
sca_tdf::sca_ct_proxy& sca_ltf_nd::calculate(
		const sca_util::sca_vector<double>& num, const sca_util::sca_vector<
				double>& den, sca_core::sca_time ct_delay, sca_util::sca_vector<double>& state,
		double input, double k, sca_core::sca_time tstep)
{
...
sca_tdf::sca_ct_proxy& sca_ltf_nd::calculate(const sca_util::sca_vector<double>& num,
		const sca_util::sca_vector<double>& den, sca_core::sca_time ct_delay, double input, double k,
		sca_core::sca_time tstep)
{
...
sca_tdf::sca_ct_proxy& sca_ltf_nd::calculate(const sca_util::sca_vector<double>& num,
		const sca_util::sca_vector<double>& den, sca_core::sca_time ct_delay, const sca_util::sca_vector<
				double>& input, double k, sca_core::sca_time tstep)
{
	proxy->register_nd(num, den, ct_delay, input, k, tstep);
	return *proxy;
