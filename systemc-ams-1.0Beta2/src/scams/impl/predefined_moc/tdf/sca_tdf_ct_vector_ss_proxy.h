...
/*****************************************************************************
 ...
 SVN Id            :  $Id: sca_tdf_ct_vector_ss_proxy.h 1187 2011-05-05 16:45:03Z karsten $
...
protected:
	...
	void  convert_to_sca_port(sca_tdf::sca_out<sca_util::sca_vector<double> >&);
	...
	sca_tdf::sca_out<sca_util::sca_vector<double> >*      out_sca_port;
	...
	sca_tdf::sca_implementation::sca_ct_delay_buffer_vector* delay_buffer;
