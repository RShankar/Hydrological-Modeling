...
/*****************************************************************************
  ...
  Created on: 15.05.2009
   ...
   SVN Version       :  $Revision: 1150 $
   SVN last checkin  :  $Date: 2011-02-06 20:01:22 +0100 (Sun, 06 Feb 2011) $
   SVN checkin by    :  $Author: karsten $
   SVN Id            :  $Id: sca_prim_channel.cpp 1150 2011-02-06 19:01:22Z karsten $
...
sca_module** sca_prim_channel::get_connected_module_list()
{
  return &(*module_list.begin());  //!!!!!!!!!!!!!!!!!!!!!!
}
...
void sca_prim_channel::register_connected_solver(sca_sync_port* sync_port)
{
  if( (sync_port->dir == sca_synchronization_obj_if::TO_ANALOG) |
      (sync_port->dir == sca_synchronization_obj_if::TO_SYSTEMC) )
  {
