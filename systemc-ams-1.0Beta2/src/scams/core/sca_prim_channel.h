...
/*****************************************************************************
 ...
 SVN Version       :  $Revision: 1098 $
 SVN last checkin  :  $Date: 2010-12-13 22:48:08 +0100 (Mon, 13 Dec 2010) $ (UTC)
 SVN checkin by    :  $Author: karsten $
 SVN Id            :  $Id: sca_prim_channel.h 1098 2010-12-13 21:48:08Z karsten $
...
protected:  //must be protected -> otherwise templates can't access
	...
	typedef std::vector<sca_core::sca_implementation::sca_sync_port*> sca_sync_port_listT;
	...
	sca_module** get_connected_module_list();
	 ...
	 */
	void register_connected_solver(sca_core::sca_implementation::sca_sync_port* solver_id);
